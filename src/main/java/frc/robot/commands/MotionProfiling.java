...
public class MotionProfiling extends Command {
  ...
  protected void initialize() {
    Trajectory left_trajectory = PathfinderFRC.getTrajectory(PathfinderConstants.PathName + ".right");
    Trajectory right_trajectory = PathfinderFRC.getTrajectory(PathfinderConstants.PathName + ".left");
